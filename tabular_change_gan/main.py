...
from finetune_others_gan import *
...
def prepare_gan_others(type_model='tvae',type_data='oracle', save_dir="GAN_models"):
    #Model directory
    model_name = f"{type_model}_bank_{type_data}_ep_1000.pt"
...
def prepare_process(type_model='tvae',type_data='oracle', save_dir="GAN_models"):
    print('--------------------------------')
...
def run(ep=1, type_model='tvae',type_data='oracle', save_dir="GAN_models"): #Remove parameters to get original version 
    ...
    final_csv = f'Datasets/final_result_{name}_{type_model}_{type_data}_iter_{ep}.csv'
